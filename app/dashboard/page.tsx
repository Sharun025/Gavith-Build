  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Welcome to Gavith Build Dashboard</h2>
        <p className="text-gray-600">This is a demo dashboard showing sample construction management data.</p>
      </div>
    </div>
  )
}
